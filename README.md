...
[![Tests](https://img.shields.io/badge/tests-182%20passed-brightgreen.svg)](#testing)
...
- **182 tests** covering domain logic, value objects, and services
- Property-based testing with Hypothesis for edge cases
- Integration tests for API endpoints
- Integration tests need a Postgres test DB (CI provides a `mizan_test` service
  container via `DATABASE_URL`); the 150 unit/property/domain tests run with no
  external services.
